...
from .types import AvailabilityType, AvailabilityInput
...
class AvailabilityMutation:
    ...
    @strawberry.mutation
    @auth_manager.role_required([UserRole.ADMIN, UserRole.NOTARY])
    async def update_availability(self, info, availability_id: str, availability_data: AvailabilityInput) -> AvailabilityType:
        try:
            availability_data = vars(availability_data)
